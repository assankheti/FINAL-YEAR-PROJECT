    ...
    () => [
      {
        ...
        items: [
          ...
          { kind: 'value', icon: 'map-pin', label: 'Farm Location', labelUrdu: 'فارم کا مقام', value: 'Punjab, Pakistan' },
      ...
      },
      {
        ...
        items: [
          ...
          { kind: 'toggle', icon: 'volume-2', label: 'Voice Assistant', labelUrdu: 'وائس اسسٹنٹ', toggleKey: 'voiceAssistant' },
      ...
      },
      {
        ...
        items: [
          ...
          { kind: 'toggle', icon: 'bell', label: 'Weather Alerts', labelUrdu: 'موسم کے الرٹس', toggleKey: 'weather' },
          { kind: 'toggle', icon: 'bell', label: 'Price Updates', labelUrdu: 'قیمت کی اپڈیٹس', toggleKey: 'price' },
        ] satisfies SettingsItem[],
      },
    ],
    []
            ...
            <View style={[styles.profileCard, { maxWidth: contentMaxWidth, alignSelf: 'center', width: '100%' }]}> 
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                ...
                <View style={{ flex: 1 , padding: 25 }}>
                  <Text style={styles.profileName}>{t({ english: 'Farmer Profile', urdu: 'کسان پروفائل' })}</Text>
                  <Text style={styles.profileMeta}>{t({ english: 'Rice Farmer • Punjab', urdu: 'چاول کے کسان • پنجاب' })}</Text>
                </View>
              </View>
            </View>
